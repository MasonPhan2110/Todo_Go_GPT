...
INSERT INTO "user" (
    ...
    $1, $2, $3
) RETURNING id, username, hashed_password, full_name, update_at, created_at
`
...
SELECT id, username, hashed_password, full_name, update_at, created_at FROM "user" 
...
func (q *Queries) UpdateUserHashedPassword(ctx context.Context, arg UpdateUserHashedPasswordParams) (User, error) {
	row := q.db.QueryRow(ctx, updateUserHashedPassword, arg.ID, arg.HashedPassword)
	var i User
	err := row.Scan(
		&i.ID,
		&i.Username,
